...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/separacao', \App\Livewire\SeparacaoListaManager::class)->name('separacao')->middleware(['auth', 'permission:separacao']);
    Route::get('/separacao/{id}', \App\Livewire\SeparacaoManager::class)->name('separacao.item')->middleware(['auth', 'permission:separacao']);
